                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className=" text-slate-400 font-medium">
                                <li className="mb-4">
                                    <Link to="/" className="hover:underline  text-slate-400 hover:text-emerald-400">
                                        Home
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/project" className="hover:underline text-slate-400 hover:text-emerald-400">
                                        Projects
                                    </Link>
                                </li>
                            </ul>
                            ...
                            <ul className=" text-slate-400 font-medium">
                                <li className="mb-4">
                                    <a
                                        ...
                                        className="hover:underline  text-slate-400 hover:text-emerald-400"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                        Github
                                ...
                                <li>
                                    <a
                                     href="https://www.linkedin.com/in/piyushh-pal/"
                                     className='hover:underline  text-slate-400 hover:text-emerald-400'
                                     target='_blank'
                                     rel='noreferrer'
                        ...
                        <div>
                            ...
                            <ul className="  text-slate-400 font-medium">
                                <li className="mb-4  text-slate-400 hover:text-emerald-400">
